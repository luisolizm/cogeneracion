...
if authentication_status:
    ...
    # ... (aquí va el resto de tus with tab_dashboard:, with tab_balance:, etc.)
    # Pega todo el contenido de las tabs que tenías antes
    # Ejemplo rápido para Dashboard:
    with tab_dashboard:
        st.title("Dashboard – Análisis de Cogeneración 2026")
        # ... tus columnas, métricas, gráfica Henry Hub, etc.

    # (continúa con las otras tabs: tab_balance, tab_econ, etc.)
    # Todo igual que antes, solo asegúrate que esté indentado dentro del if
